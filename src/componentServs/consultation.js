...
function saveConsultation(obj) {
    return new Promise((resolve, reject) => {
        try {
            axios
                .post(process.env.VUE_APP_ROOT_API + "/consultations/insert", obj.body, {
                    headers: {
...
function getListConsultation(obj) {
    return new Promise((resolve, reject) => {
        try {
            axios
                .post(process.env.VUE_APP_ROOT_API + "/consultations/" + obj.active, obj.body, {
                    headers: {
                        'Authorization': obj.token
                    }
                })
...
function getConsultation(obj) {
    return new Promise((resolve, reject) => {
        try {
            axios
                .get(process.env.VUE_APP_ROOT_API + "/consultation/" + obj.idConsultation, {
                    headers: {
                        'Authorization': obj.token
                    }
                })
...
function updatedConsultation(obj) {
    return new Promise((resolve, reject) => {
        try {
            axios
                .put(process.env.VUE_APP_ROOT_API + "/consultation/" + obj.idConsultation,
                    obj.body, {
                        headers: {
                            'Authorization': obj.token
                        }
...
function deleteConsultation(obj) {
    return new Promise((resolve, reject) => {
        try {
            axios
                .delete(process.env.VUE_APP_ROOT_API + "/consultation/" + obj.body.consultationId,
                    obj.body, {
                        headers: {
                            'Authorization': obj.token
                        }
