          ...
          <v-container fluid grid-list-md px-0 py-0>
            <v-layout row wrap>
              ...
              <v-flex xs8 v-if="useListMedicines">
                <v-autocomplete v-model="medications" :items="items" :readonly="validateRead()"
                  ...
                  <v-slide-x-reverse-transition slot="append-outer" mode="out-in">
                    <v-btn dark small icon color="grey white--text" @click="appendListMedicines">
                      <v-icon>add</v-icon>
                    </v-btn>
              ...
              <v-flex xs12>
                ...
                <v-textarea outline v-model="dosis" name="input-7-4" label="Dosis"
                  :readonly="validateRead()"></v-textarea>

              </v-flex>

              <v-flex xs12 class="text-sm-left">
                <v-data-table :headers="headers" :items="assignedMedicines" class="elevation-1"
