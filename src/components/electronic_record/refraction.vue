<template>
  <v-container>
    <v-form autocomplete="off" ref="formRefractionRef" v-model="formRefraction" lazy-validation>
    <v-card class="elevation-3">
        <v-card-title primary-title class="blue-grey darken-1">
            <span class="subheading white--text text-capitalize">{{$t('title.refraction')}}</span>
        </v-card-title>
            ...
            <v-container fluid grid-list-md px-0 py-0>
                <v-layout row wrap>
                    <v-flex xs2 offset-xs2>
                        <span class="body-2"><v-checkbox :label="$t('title.cycle')" v-model="refraccion.ciclo" :readonly="validateRead()"></v-checkbox></span>
                    </v-flex>
                    <v-flex xs2>
                        <span class="body-2"><v-checkbox :label="$t('title.est')" v-model="refraccion.est" :readonly="validateRead()"></v-checkbox></span>
                    </v-flex>
                    <v-flex xs2>
                        <span class="body-2"><v-checkbox :label="$t('title.dinm')" v-model="refraccion.dinm" :readonly="validateRead()"></v-checkbox></span>
                    </v-flex>
                </v-layout>
                <v-layout row wrap>
                    <v-flex xs2 offset-xs2>
