<template>
  <v-container>
    <v-form autocomplete="off" ref="formPreviousSurgeriesRef" v-model="formPreviousSurgeries" lazy-validation>
    <v-card class="elevation-3">
        <v-card-title primary-title class="blue-grey darken-1">
            <span class="subheading white--text text-capitalize">{{$t('title.previous_surgeries')}}</span>
        </v-card-title>
                            ...
                            <v-container fluid grid-list-md px-0 py-0>
                                ...
                                <v-layout align-center justify-center row fill-height>
                                    <v-flex xs12 align-center>
                                        ...
                                        v-model="cirugias[getPosition('Cirugía de Córnea')].eyeRight"
                                        :readonly="validateRead()"
                                        ></v-switch>
                                    </v-flex>
                                </v-layout>
                            ...
                            <v-container fluid grid-list-md px-0 py-0>
                                ...
                                <v-layout align-center justify-center row fill-height>
                                    <v-flex xs12 justify-center>
                                        <v-switch
                                        :label="`${$t('antecedent.corneal_surgery')}`"
                                        v-model="cirugias[getPosition('Cirugía de Córnea')].eyeLeft"
                                        :readonly="validateRead()"
                                        ></v-switch>
                                    </v-flex>
                                </v-layout>
        ...
        setDataAntecedent () {
            ...
            if(this.storeConsultation.record.cirugias){
                ...
                if(this.storeConsultation.record.cirugias.othersEyeRight) {
                    this.othersEyeRight = this.storeConsultation.record.cirugias.othersEyeRight
                }
                if(this.storeConsultation.record.cirugias.othersEyeLeft)  {
                    this.othersEyeLeft = this.storeConsultation.record.cirugias.othersEyeLeft
                }
            }
        }
    },
