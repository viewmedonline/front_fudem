<template>
  <v-container>
    <v-form
      autocomplete="off"
      ref="formAntecedentRef"
      v-model="formAntecedent"
      lazy-validation
    >
            ...
            <v-layout align-center justify-center row fill-height>
              <v-flex xs3>
                <v-layout>
                  ...
                  <v-flex xs5 v-if="antecedents[3].value">
                    <v-text-field
                      v-model="hemoglutest"
                      label="Hemoglutest"
                      required
  ...
  methods: {
    ...
    setDataAntecedent() {
      ...
      function antecedentSpecialty(objName) {
        antecedentaAux =
          _this.storeConsultation[objName].data.record.antecedent.antecedentes;
        if (antecedentaAux.length > 0) _this.antecedents = antecedentaAux;

        _this.otros =
          _this.storeConsultation[objName].data.record.antecedent.otros;
        _this.medicamentosAntecedent =
          _this.storeConsultation[
            objName
          ].data.record.antecedent.medicamentosAntecedent;
      }
