<template>
  <v-container>
    <v-form autocomplete="off" ref="formLensometryRef" v-model="formLensometry" lazy-validation>
    <v-card class="elevation-3">
        <v-card-title primary-title class="blue-grey darken-1">
            <span class="subheading white--text text-capitalize">{{$t('title.lensometry')}}</span>
        </v-card-title>
    ...
    methods: {
        ...
        setLensometry () {
            if (
                ...
                if (this.storeConsultation.objPreliminary.data) this.lensometria = this.storeConsultation.objPreliminary.data.lensometria
                else if (this.storeConsultation.lensometria) this.lensometria = this.storeConsultation.lensometria
