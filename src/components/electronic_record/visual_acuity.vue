<template>
  <v-container>
    <v-form autocomplete="off" ref="formVisualAcuityRef" v-model="formVisualAcuity" lazy-validation>
    <v-card class="elevation-3">
        ...
        <v-card-text>
            <v-container fluid grid-list-md px-0 py-0>
                ...
                <v-layout row wrap>
                    <v-flex xs1 offset-xs2 text-sm-left class="vm-p-esp">
                        {{$t('title.re')}}:
                    </v-flex>
                    <v-flex xs3>
                        <v-select
    ...
    methods: {
        ...
        setVisualAcuity () {
            if (
                ...
                if (this.storeConsultation.objPreliminary.data) this.visualAcuity = this.storeConsultation.objPreliminary.data.agudezaVisual
                else if(this.storeConsultation.agudezaVisual) this.visualAcuity = this.storeConsultation.agudezaVisual
