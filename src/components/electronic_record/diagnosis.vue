<template>
  <v-container>
    <v-form autocomplete="off" ref="formDiagnosisRef" v-model="formDiagnosis" lazy-validation>
        <v-card class="elevation-3">
            <v-card-title primary-title class="blue-grey darken-1">
                <span class="subheading white--text text-capitalize">{{$t('title.diagnosis_and_observations')}}</span>
            </v-card-title>
        ...
        <v-card class="elevation-3">
            <v-card-title primary-title class="blue-grey darken-1">
                <span class="subheading white--text text-capitalize">{{$t('title.observationsOphthalmology')}}</span>
            </v-card-title>
            <v-divider light class="vm-border-color-2"></v-divider>
            <v-card-text>
                <v-container fluid grid-list-md px-0 py-0>
        ...
        <v-card class="elevation-3">
            <v-card-title primary-title class="blue-grey darken-1">
                <span class="subheading white--text text-capitalize">¿Se dió Receta?</span>
            </v-card-title>
            <v-divider light class="vm-border-color-2"></v-divider>
            <v-card-text>
                <v-container fluid grid-list-md px-0 py-0>
    ...
    methods: {
        ...
        setDiagnostics(){
            if(this.storeConsultation.diagnosticoObservaciones) {
                if (this.storeConsultation.diagnosticoObservaciones.diagnostico.length > 0)
                    this.diagnosticoObservaciones = this.storeConsultation.diagnosticoObservaciones
            }
