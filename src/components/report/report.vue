<template>
    <v-container>
    	    ...
    	    >
    	      <v-tab
    	        ripple	
                @click="tabsActive('ophthalmologist')"
    	      >
    	        Oftalmología
    	      </v-tab>
                                ...
                                <v-flex xs12 class="text-lg-right pt-4" v-if="reportOphthalmology && !reportOphthalmologyDisplay">
                                    ...
                                    >
                                        <template slot="items" slot-scope="props">
                                          ...
                                          <td class="text-xs-center">
                                            {{diagnosesConsulting(props.item.objOphthalmology.data.diagnostic)}}
                                          </td>
                                        </template>
                                    </v-data-table>
                                ...
                                <v-flex xs12 class="text-lg-right pt-4" v-if="reportOptometrist && !reportOptometristDisplay">
                                    ...
                                    >
                                        <template slot="items" slot-scope="props">
                                          ...
                                          <td class="text-xs-center">
                                            {{setDiagnosis(props.item.objOptometrist.data.diagnosticoObservaciones.diagnostico)}}
                                          </td>
                                          <td class="text-xs-center">
                                            {{langTypeConsulting(props.item.typeConsultation, props.item)}}
                                          </td>
                                        </template>
                                    </v-data-table>
                                    <div class="text-xs-center pt-2">
            ...
            <div id="Divtableophthalmologist" v-if="reportOphthalmology  && reportOphthalmologyDisplay && rolePhi == 'ophthalmologist'">
                <table 
                ...
                >
                    <tr>
                      <td colspan="11">
                        ...
                        >
                            <tr>
                                <td colspan="11" align="left"><strong>FUDEM - CENSO DE PACIENTES EN CLINICA DE OFTALMOLOGÍA</strong></td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2" ><strong>OFTALMÓLOGO:</strong></td>
                                <td align="left" colspan="9" >{{model.forename}} {{model.surname}}</td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2" ><strong>FECHA:</strong></td>
                                <td align="left" colspan="9" >{{dateFrom}} AL {{dateTo}}</td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2" ><strong>SUCURSAL:</strong></td>
                                <td align="left" colspan="9" >{{ sucursalName(sucursal).Name}}</td>
                            </tr>
                        </table>
                      </td>
                ...
                <div class="text-xs-center pt-2" v-if="resultOphthalmology.length > 0 && rolePhi == 'ophthalmologist'">
                    ...
                    <v-btn @click="reportOphthalmologyDisplay = false">
                        Volver
                    </v-btn>
                </div>
            </div>
            <div id="Divtableoptometrist" v-if="reportOptometrist && reportOptometristDisplay && rolePhi == 'optometrist'">
                <table 
                    id="tableoptometrist"
                    border="1"
                    width="100%"
                ...
                >
                    <tr>
                      <td colspan="19">
                        ...
                        >
                            <tr>
                                <td colspan="19" align="left"><strong>FUDEM - CENSO DE PACIENTES EN CLINICA DE OFTALMOLOGÍA</strong></td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2" ><strong>OPTÓMETRA:</strong></td>
                                <td align="left" colspan="17" >{{model.forename}} {{model.surname}}</td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2" ><strong>FECHA:</strong></td>
                                <td align="left" colspan="17" >{{dateFrom2}} AL {{dateTo2}}</td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2" ><strong>SUCURSAL:</strong></td>
                                <td align="left" colspan="17" >{{ sucursalName(sucursal).Name}}</td>
                            </tr>
                        </table>
                      </td>
                    ...
                    <tr v-for="(consultas, j) in resultOptometrist" v-if="resultOptometrist.length > 0 && rolePhi == 'optometrist'">
                      ...
                      <div v-for="(diagnos, j) in consultas.objOptometrist.data.diagnosticoObservaciones.diagnostico" v-if="j < 5" style="    display: contents;"> 
                          <td class="text-xs-center"  align="center" width="2%">
                            <strong>
                      ...
                      <td class="text-xs-center">
                        {{consultas.objOptometrist.data.receta ? consultas.objOptometrist.data.receta : 'NO'}}
                      </td>
                      
                    </tr>
                </table>
                <div class="text-xs-center pt-2" v-if="resultOptometrist.length > 0 && rolePhi == 'optometrist'"> 
                    <v-btn @click="csvExport('tableoptometrist')">
                        Exportar a Excel
                    </v-btn>
                    <v-btn @click="printOpt('tableoptometrist')" >
                        Exportar a Pdf
                    </v-btn>
                    <v-btn @click="reportOptometristDisplay = false">
                        Volver
                    </v-btn>
                </div>
            </div>
  ...
  data() {
    ...
    methods: {
        sucursalName(sucursalId){
            let sucursalFilter = this.sucursalList.filter(sucursal => sucursal._id == sucursalId);
        ...
        printOft(table) {
            ...
            .then(report => {
                ...
                for(let i = 0; i < pageCount; i++) { 
                    doc.setPage(i);
                    doc.text(225,10, "Fecha de Emisión: "+moment().locale('es').format('L')); 
                    doc.text(15,200, "Página "+doc.internal.getCurrentPageInfo().pageNumber + " de " + pageCount);
                }
                doc.save('OFT-'+this.dateFormat(this.dateFrom)+'-'+this.dateFormat(this.dateTo)+'.pdf');
            })
        },
        printOpt(table) {
            ...
            this.returnTable('OPT')
                .then(report => {
                    ...
                    doc.save('OPT-'+this.dateFormat(this.dateFrom2)+'-'+this.dateFormat(this.dateTo2)+'.pdf');
                })
        },
        ...
        async setDiagnosisPdf(diagnosis){
            ...
            for (let i in diagnosis) {
                if(i < 5){
                    diagnosisReportPdf.push(diagnosis[i].eyeRight ? 'S' : 'N',diagnosis[i].eyeLeft ? 'S' : 'N')
                }
            }
            ...
            if(section == 'OFT'){
                for (let i in this.resultOphthalmology) {
                    itemReport = [
                        ...
                        {
                            content:this.dateFormat(this.resultOphthalmology[i].control.created_at),
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 12
                        ...
                        {
                            content:this.hour(this.resultOphthalmology[i].control.created_at),
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 8
                        ...
                        {
                            content:this.resultOphthalmology[i].person.forename+''+this.resultOphthalmology[i].person.surname,
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 15
                        ...
                        {
                            content:(this.resultOphthalmology[i].person.gender == 'Masculino' ? 'M' : 'F'),
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 6
                        ...
                        {
                            content:this.diagnosesConsulting(this.resultOphthalmology[i].objOphthalmology.data.diagnostic),
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 20
                        ...
                        {
                            content:this.resultOphthalmology[i].objOphthalmology.data.observaciones.medicamentos.length,
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 10
                        ...
                        {
                            content:this.resultOphthalmology[i].objOphthalmology.data.process.length,
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 12
                ...
                for (let i in this.resultOptometrist) {
                    ...
                    itemReport = [
                        ...
                        {
                            content:this.dateFormat(this.resultOptometrist[i].control.created_at),
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 12
                        ...
                        {
                            content:this.resultOptometrist[i].person.forename+''+this.resultOptometrist[i].person.surname,
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 15
                        ...
                        {
                            content:(this.resultOptometrist[i].person.gender == 'Masculino' ? 'M' : 'F'),
                            styles: {
                                halign: 'center',
                                valign: 'middle',
                                cellWidth: 6
                    ...
                    await this.setDiagnosisPdf(this.resultOptometrist[i].objOptometrist.data.diagnosticoObservaciones.diagnostico)
                        .then(list => {
                        ...
                        itemReport.push(
                            {
                                content: this.langTypeConsulting(this.resultOptometrist[i].typeConsultation),
                                styles: {
                                    halign: 'center',
                                    valign: 'middle',
                                    cellWidth: 12
                        ...
                        itemReport.push(
                            {
                                content: this.resultOptometrist[i].objOptometrist.data.receta ? this.resultOptometrist[i].objOptometrist.data.receta : 'NO',
                                styles: {
                                    halign: 'center',
                                    valign: 'middle',
                                    cellWidth: 8
        ...
        csvExport(reportSec) {
            ...
            a.charset = 'UTF-8';
            a.href = data_type + ', ' + '<html><head><meta http-equiv="content-type" content="application/vnd.ms-excel; charset=UTF-8"></head><body>'+table_html+'</body></html>';
            let auxName = ''
            if(reportSec == 'tableophthalmologist'){    
                auxName = 'OFT-'+this.dateFormat(this.dateFrom)+'-'+this.dateFormat(this.dateTo)
            }
            else{
                auxName = 'OPT-'+this.dateFormat(this.dateFrom2)+'-'+this.dateFormat(this.dateTo2)
            }
        ...
        generarReport(specialty){
            if (this.$refs[specialty].validate()) {
                ...
                if(specialty == 'ophthalmology'){
                    objAux.body['objOphthalmology.data.responsableConsultation'] = this.model._id
                    objAux.body['control.active'] = false
                    objAux.body['control.created_at'] = {
                        $gte: moment(this.dateFrom).utc(0).set({hour:0,minute:0,second:0,millisecond:0}).format(),
                        $lte: moment(this.dateTo).utc(0).set({hour:23,minute:59,second:59,millisecond:59}).format()
                    }
                    if(diagnostic)
                        objAux.body['objOphthalmology.data.diagnostic.code'] = diagnostic

                    objAux.body.dataReturn = {'objOphthalmology.data':1,'control':1}
                }
                else{
                    let diagnosticoOpt = []
                    if(this.diagnosis.includes( 'Todos' )){
                        ...
                        diagnosticoOpt = this.diagnosis

                    objAux.body['objOptometrist.data.responsableConsultation'] = this.model._id
                    objAux.body['objOptometrist.data.diagnosticoObservaciones.diagnostico'] =   
                        { 
                            $elemMatch: 
                                        { 
                    ...
                    objAux.body['control.active'] = false
                    objAux.body['control.created_at'] = {
                        $gte: moment(this.dateFrom2).set({hour:0,minute:0,second:0,millisecond:0}).utc(0).format(),
                        $lt: moment(this.dateTo2).set({hour:23,minute:59,second:59,millisecond:59}).utc(0).format()
                    }
                    objAux.body.dataReturn = {'objOptometrist.data':1,'control':1,'typeConsultation':1}
                }
        ...
        getDoctor(){
            ...
            personServ.getPersonList(objAux).then(result => {
                this.entries = result
            })
            .catch(err => {
                console.log(err)
    ...
    computed: {
      pagesOpt () {
        if (this.paginationOpt.rowsPerPage == null ||
          this.paginationOpt.totalItems == null
        ) return 0
        return Math.ceil(this.paginationOpt.totalItems / this.paginationOpt.rowsPerPage)
      },
      pagesOft () {
        if (this.paginationOft.rowsPerPage == null ||
          this.paginationOft.totalItems == null
        ) return 0

        return Math.ceil(this.paginationOft.totalItems / this.paginationOft.rowsPerPage)
      },
      items () {
        return this.entries.map(entry => {
          const Description = entry.forename.length > this.descriptionLimit
      ...
      items3 () {
        return this.entries2.map(entry => {
          const DescriptionPatien = entry.forename.length > this.descriptionLimit
            ? entry.forename.slice(0, this.descriptionLimit) + '...'
            : entry.forename
